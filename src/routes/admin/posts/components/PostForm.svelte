<script lang="ts">
	...
	// Quiz Gate fields
	let enableQuizGate = false;
	let quizGateType: 'DIFFICULTY' | 'SPECIFIC_QUIZ' = 'DIFFICULTY';
	let quizGateDifficulty: 'VOTIST' | 'SCHOLAR' | 'MENTOR' = 'VOTIST';
	let quizGateQuizId: string | null = null;
	let quizGateQuizTitle: string = '';
	let quizSearchQuery = '';
